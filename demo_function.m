...
[ bert_lh_curv ] = load_patient_data_( bert_lh_curv , 16 , 13 );
[ bert_rh_curv ] = load_patient_data_( bert_rh_curv , 17 , 34 );
[ buck04 ] = load_patient_data_( buck04 , 16 , 13 );

[ bert_lh_vol ] = load_patient_data_( bert_lh_vol , 16 , 8 );
[ bert_rh_vol ] = load_patient_data_( bert_rh_vol , 17 , 28 );
...
[bert_rh_vol] = surf_to_pyramid(bert_lh_vol);
