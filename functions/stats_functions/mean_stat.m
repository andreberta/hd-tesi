function mean_stat(patient,path_patient,psz,par_lh,par_rh,do_sc)
...
stat_sc_lh = zeros(length(regions)+1,2*(visit_number-1));
stat_sc_rh = zeros(length(regions)+1,2*(visit_number-1));

stat_rb_lh = zeros(length(regions)+1,2*(visit_number-1));
stat_rb_rh = zeros(length(regions)+1,2*(visit_number-1));

stat_pw_lh = zeros(length(regions)+1,2*(visit_number-1));
stat_pw_rh = zeros(length(regions)+1,2*(visit_number-1));
